<template>
  <div class="card">
    <div class="card-header justify-content-between d-flex align-items-center">
      <h2 class="text-muted">Payment Items</h2>
      <b-button class="ml-2" variant="outline-primary" href="/payment-items/create">Create</b-button>
    </div>
    <div class="card-body">
      <vue-good-table
        ref="my-table"
      ...
      >
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'buttons'">
            <a class="text-success" title="edit" :href="`/payment-items/${props.row.id}/edit`">
...
export default {
  ...
  mounted() {
    this.loadItems("/payment-items/json");
  },
  methods: {}
};
</script>  
