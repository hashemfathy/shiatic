        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              ...
              <b-badge variant="info">5</b-badge>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
        ...
        <div class="toolbar">
          ...
          <b-dropdown variant="light" class="ml-1">
            ...
            <b-dropdown-item href="#">
              add label
              <b-badge variant="danger">Home</b-badge>
            </b-dropdown-item>
            <b-dropdown-item href="#">
              add label
              <b-badge variant="info">Job</b-badge>
            </b-dropdown-item>
            <b-dropdown-item href="#">
              add label
              <b-badge variant="success">Clients</b-badge>
            </b-dropdown-item>
            <b-dropdown-item href="#">
              add label
              <b-badge variant="warning">News</b-badge>
            </b-dropdown-item>
          </b-dropdown>
        </div>
        <div class="details">
          ...
          <div class="attachments">
            <div class="attachment">
              <b-badge variant="danger">zip</b-badge>
              <b>bootstrap.zip</b>
              <i>(2,5MB)</i>
              <span class="menu">
            ...
            <div class="attachment">
              <b-badge variant="info">txt</b-badge>
              <b>readme.txt</b>
              <i>(7KB)</i>
              <span class="menu">
                <a href="#" class="fa fa-search"></a>
            ...
            <div class="attachment">
              <b-badge variant="success">xls</b-badge>
              <b>spreadsheet.xls</b>
              <i>(984KB)</i>
              <span class="menu">
                <a href="#" class="fa fa-search"></a>
