...
export default {
  ...
  data: function() {
    return {
      ...
      tableItems: [
        {
          avatar: { url: "/images/user.png", status: "success" },
          user: {
        ...
        {
          avatar: { url: "/images/user.png", status: "danger" },
          user: {
            name: "Avram Tarasios",
            new: false,
            registered: "Jan 1, 2015"
        ...
        {
          avatar: { url: "/images/user.png", status: "warning" },
        ...
        {
          avatar: { url: "/images/user.png", status: "" },
